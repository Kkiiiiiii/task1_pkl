                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button class="dropdown-item" data-bs-toggle="modal"
                                                data-bs-target="#editData{{ $e->id }}">
                                                <i class="ti ti-pencil me-1"></i> Edit
                                            </button>
                                            <form action="{{ route('educate-delete', Crypt::encrypt($e->id)) }}"
                                                method="POST">
                                                @csrf
                                                <button class="dropdown-item text-danger"
                                                    onclick="return confirm('Yakin Hapus Data Pendidikan {{ $e->nama_sekolah }}' + '?')">
                                ...
                                <div class="modal-dialog modal-lg modal-simple">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form method="POST"
                                                action="{{ route('educate-update', Crypt::encrypt($e->id)) }}">
                                                @csrf
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="jenjang_pendidikan" class="form-select">
                                                            <option value="SD"
                                                                {{ $e->jenjang_pendidikan == 'SD' ? 'selected' : '' }}>SD
                                                            </option>
                                                            <option value="SMP"
                                                                {{ $e->jenjang_pendidikan == 'SMP' ? 'selected' : '' }}>SMP
                                                            </option>
                                                            <option value="SMA"
                                                                {{ $e->jenjang_pendidikan == 'SMA' ? 'selected' : '' }}>SMA
                                                            </option>
                                                            <option value="SMK"
                                                                {{ $e->jenjang_pendidikan == 'SMK' ? 'selected' : '' }}>SMK
                                                            </option>
                                                            <option value="S1"
                                                                {{ $e->jenjang_pendidikan == 'S1' ? 'selected' : '' }}>S1
                                                            </option>
                                                            <option value="S2"
                                                                {{ $e->jenjang_pendidikan == 'S2' ? 'selected' : '' }}>S2
                                                            </option>
                                                            <option value="S3"
                                                                {{ $e->jenjang_pendidikan == 'S3' ? 'selected' : '' }}>S3
                                                            </option>
                                                            <option value="Kursus"
                                                                {{ $e->jenjang_pendidikan == 'Kursus' ? 'selected' : '' }}>Kursus
                                                            </option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="pilihan" class="form-select">
                                                            <option value="Formal"
                                                                {{ $e->pilihan == 'Formal' ? 'selected' : '' }}>Formal</option>
                                                            <option value="Non-Formal"
                                                                {{ $e->pilihan == 'Non-Formal' ? 'selected' : '' }}>Non Formal
                                                            </option>
                                                        </select>
                                                    </div>
